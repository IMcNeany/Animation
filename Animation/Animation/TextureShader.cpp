...
bool TextureShader::InitializeShader(ID3D11Device* device, HWND hwnd, LPCSTR vsFilename, LPCSTR psFilename)
{
	...
	result = D3DX11CompileFromFile((LPCSTR)psFilename, NULL, NULL, "PixelTextureShader", "ps_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0, NULL,
	...
	D3DXMATRIX projectionMatrix, ID3D11ShaderResourceView* texture)
{
	...
	// put matrices into the constant buffer.
